...
cfg.intersection_spiral_frame = 3400
...
cfg.use_pseudo_fusion = True
cfg.pseudo_filter_labels = []
cfg.val_list = []
cfg.depth_object = []
cfg.start = 6060
cfg.decay_rate = 1.
...
cfg.lambda_learn_semantic  = 0.0005
cfg.weight_th = 0.
cfg.dist_lambda = 0.005
cfg.xyz_res = 6
cfg.view_res = 4
cfg.ratio = .5
cfg.lambda_fix_semantic = 1.
cfg.lambda_fix_instance = 1.
cfg.lambda_2d_semantic= 1.
cfg.lambda_3d_semantic = 1.
cfg.normal_weight = 0.005
cfg.seq_id = -1
cfg.sequence = 0
cfg.consistency_thres = -1.
cfg.use_pseudo_filter = False
cfg.use_decay = True
...
cfg.use_instance_loss = False
cfg.use_post_processing = False
cfg.merge_instance = False
cfg.fisheye_weight_th = 5e-4
cfg.fe_sky_sample_ratio = -1.
cfg.n_hidden_layers = 2
cfg.scene_mlp_neuron = 128
cfg.scene_code_ch = 24

# panoramic 360 configs
cfg.intersection_spiral_frame = 0
cfg.dir_02 = [0., 0., 0.]
cfg.dir_02_max_angle = 1.
cfg.dir_03 = [0., 0., 0.]
cfg.dir_03_max_angle = 1.
cfg.x_theta = 0.
cfg.y_theta = 0.
cfg.z_theta = 0.
