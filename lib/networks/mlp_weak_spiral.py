...
class NeRF(nn.Module):
    ...
    def forward(self, xyz, z_vals, ray_dir, frame_idx, cam_idx):
        ...
        img_code_left = self.img_codes[frame_idx + cfg.train_frames * 0]
        img_code_right = self.img_codes[frame_idx + cfg.train_frames * 1]
        cam_idx = torch.repeat_interleave(cam_idx, N_samples, dim=1)[0]
        img_code = img_code_left[None] * cam_idx[...,None] + img_code_right[None] * (1-cam_idx[...,None])
